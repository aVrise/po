...
def fit(x, y, fittype):
    ...
    if fittype==2:
        ...
        print popt[0],popt[1],popt[2],dat[2,:].min(),dat[2,:].max(),r_value**2,fitFunction(-0.1,popt[0],popt[1],popt[2])
...
for aii in sys.argv[1:]:
    ...
    for zc1 in [0.530779,0.531069]: #psur,dsur
